...
if ($doc_root === $project_root_norm) {
    ...
    $base_project = basename($project_root);
...
if (strpos($url, $base_path_url) === 0 && $base_path_url !== '/') {
...
$routes = [
    ...
    'admin-rifas-publicidad' => $base_path . '/views/rifas/publicidad/index.php',
...
if (!$routeMatched) {
    ...
    if (file_exists($error_file)) {
        ...
        $home = $base_path_url === '/' ? '/' : $base_path_url . '/';

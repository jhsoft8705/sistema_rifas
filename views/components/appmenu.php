            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUsuarios" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-user-settings-line"></i> <span data-key="t-usuarios">Usuarios y Seguridad</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarUsuarios">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="usuarios" class="nav-link" data-key="t-usuarios">Usuarios</a>
                            </li>
                            <li class="nav-item">
                                <a href="roles" class="nav-link" data-key="t-roles">Roles</a>
                            </li>
                            <li class="nav-item">
                                <a href="permisos" class="nav-link" data-key="t-permisos">Permisos</a>
                            </li>
                            <li class="nav-item">
                                <a href="sesiones" class="nav-link" data-key="t-sesiones">Sesiones</a>
                            </li>
                            <li class="nav-item">
                                <a href="audit-logs" class="nav-link" data-key="t-audit">Auditoría</a>
                            </li>
                        </ul>
                    </div>
                </li>-->
                ...
                <!-- ASISTENCIA
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAsistencia" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarAsistencia">
                        <i class="ri-time-line"></i> <span data-key="t-asistencia">Asistencia</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarAsistencia">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="marcaciones" class="nav-link" data-key="t-marcaciones">Marcaciones</a>
                            </li>
                            <li class="nav-item">
                                <a href="ajustes-marcacion" class="nav-link" data-key="t-ajustes">Ajustes de
                                    Marcación</a>
                            </li>
                            <li class="nav-item">
                                <a href="logs-biometricos" class="nav-link" data-key="t-logs">Logs Biométricos</a>
                            </li>
                            <li class="nav-item">
                                <a href="logs-pendientes" class="nav-link" data-key="t-pendientes">Logs Pendientes</a>
                            </li>
                            <li class="nav-item">
                                <a href="sincronizacion" class="nav-link" data-key="t-sync">Cola de Sincronización</a>
                            </li>
                        </ul>
                    </div>
                </li> -->
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPlanilla" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarPlanilla">
                        <i class="ri-money-dollar-circle-line"></i> <span data-key="t-planilla">Planilla y
                            Beneficios</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarPlanilla">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="conceptos-planilla" class="nav-link" data-key="t-conceptos">Conceptos de
                                    Planilla</a>
                            </li>
                            <li class="nav-item">
                                <a href="beneficios-laborales" class="nav-link" data-key="t-beneficios">Beneficios
                                    Laborales</a>
                            </li>
                            <li class="nav-item">
                                <a href="planillas" class="nav-link" data-key="t-planillas">Planillas</a>
                            </li>
                            <li class="nav-item">
                                <a href="detalle-planilla" class="nav-link" data-key="t-detalle">Detalle de Planilla</a>
                            </li>
                        </ul>
                    </div>
                </li>-->

...
<head>
    <meta charset="utf-8" />
    <title>Proceso de Juego | Sistema de Rifas</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Proceso de juego de rifas" name="description" />
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Proceso de Juego de Rifas</h4>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">
                                        <i class="ri-gamepad-line me-2"></i>Rifas Listas para Jugar
                                    </h5>

                                    <div class="d-flex flex-wrap w-100 gap-3 mt-3">
                                        <div class="d-flex flex-wrap flex-grow-1 gap-3">
                                            <button class="btn btn-outline-warning" id="btn_recargar_juegos"
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle table-nowrap mb-0" id="tabla_juegos">
    ...
    <script src="<?= Enrutamiento::dominio() ?>/views/juegos/juegos.js"></script>
</body>
